import { Image, View, Text, FlatList, TextInput, SafeAreaView, Button, StyleSheet, ScrollView, KeyboardAvoidingView, Keyboard } from 'react-native'
...
const ReplyFeed = ({ navigation, feedId }) => {
